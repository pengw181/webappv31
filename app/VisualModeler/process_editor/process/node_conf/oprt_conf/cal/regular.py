...
def regular(input_var, output_var, value_type, var_index, transpose, ruler, fetch):
    ...
    if ruler:
        ...
        add_flag = analyze_conf(begin_row=ruler.get("解析开始行"), enable_magic=ruler.get("通过正则匹配数据列"),
        ...
        if add_flag:
            ...
            if alert.title_contains("成功"):
                ...
                browser.switch_to.frame(
                    browser.find_element_by_xpath("//iframe[contains(@src,'operateCfgRegular.html')]"))
            else:
