...
from common.page.func.choose_dir import choose_ftp_dir
from app.VisualModeler.process_editor.process.node_conf.business_conf.crawler_element import crawler_element
from common.tools.updateData import update_dict
from common.page.func.upload import upload
from app.VisualModeler.process_editor.process.node_conf.oprt_conf.opt import OptTreeServer
...
def crawler_business(node_name, system_name, element_config, tree_set, advance_set):
    ...
    # 选择目标系统
    if system_name:
        browser.find_element_by_xpath("//*[@name='platformId']/preceding-sibling::input").click()
        system_element = browser.find_element_by_xpath(
            "//*[contains(@id,'platformId') and text()='{0}']".format(system_name))
        ...
        # 选择目标系统后，需要先保存业务配置
        browser.find_element_by_xpath("//*[@onclick='saveFetchContent(true)']//*[text()='保存']").click()
        log.info("保存业务配置")
        ...
        # 切换到节点iframe
        browser.switch_to.frame(browser.find_element_by_xpath("//iframe[contains(@src,'./node/crawlerNode.html?')]"))
        # 切换到业务配置iframe
        browser.switch_to.frame(browser.find_element_by_xpath("//iframe[@id='busi_crawler_node']"))
    ...
    if advance_set:
        if advance_set.get("flag") == "是":
            ...
            browser.find_element_by_xpath("//*[@name='timeOut']/preceding-sibling::input").clear()
            browser.find_element_by_xpath("//*[@name='timeOut']/preceding-sibling::input").send_keys(timeout)
    ...
    # 保存业务配置
    save_elements = browser.find_elements_by_xpath("//*[@onclick='saveFetchContent(true)']//*[text()='保存']")
...
def element_list(actionType, element):
    ...
    if actionType == "添加":
        ...
        # 点击添加按钮
        add_elements = browser.find_elements_by_xpath("//*[@id='addBtn']//*[text()='添加']")
        ...
        try:
            browser.find_element_by_xpath("//*[@field='elementName']//*[text()='{0}']".format(obj)).click()
        except NoSuchElementException:
            ...
            # 点击修改按钮
            edit_elements = browser.find_elements_by_xpath("//*[@id='editBtn']//*[text()='修改']")
        ...
        try:
            ...
            # 点击删除按钮
            edit_elements = browser.find_elements_by_xpath("//*[@id='delBtn']//*[text()='删除']")
            for e in edit_elements:
                if e.is_displayed():
                    e.click()
                    break
            ...
            if alert.title_contains(obj, auto_click_ok=False):
                ...
                if alert.title_contains("操作成功"):
                    ...
                    log.warn("元素 {0} 删除失败，失败提示: {1}".format(obj, msg))
                    result = False
            else:
                log.warn("元素 {0} 删除失败，失败提示: {1}".format(obj, msg))
                result = False
        ...
        # 点击复制按钮
        browser.find_element_by_xpath("//*[@id='copyBtn']//*[text()='复制']").click()
        # 等待页面加载
        wait = WebDriverWait(browser, 30)
        wait.until(ec.frame_to_be_available_and_switch_to_it((
        ...
        # 选择节点名称
        browser.find_element_by_xpath("//*[@id='nodeId']/following-sibling::span//a").click()
        node_name = element.get("节点名称")
        browser.find_element_by_xpath("//*[contains(@id,'nodeId') and text()='{0}']".format(node_name)).click()
        log.info("选择节点: {0}".format(node_name))
        # 查询复制元素
        copy_element = element.get("复制元素")
        browser.find_element_by_xpath("//*[@name='elementName']/preceding-sibling::input").send_keys(copy_element)
        browser.find_element_by_xpath("//*[@id='btn']//span[text()='查询']").click()
        sleep(1)
        page_wait()
        # 选择复制元素
        try:
            browser.find_element_by_xpath("//*[@field='elementName']//*[text()='{0}']".format(copy_element)).click()
        except NoSuchElementException:
            ...
            add_copy_button = browser.find_elements_by_xpath("//*[@id='addBtn']//span[text()='添加']")
            ...
            browser.switch_to.frame(
                browser.find_element_by_xpath("//iframe[contains(@src,'crawlerCopyStepRename.html')]"))
            if element.__contains__("元素名称"):
                element_name = element.get("元素名称")
                element_name_input = browser.find_elements_by_xpath(
                    "//*[@id='elementName']/following-sibling::span/input[1]")
                for e in element_name_input:
                    if e.is_displayed():
                        ...
                        break
                sleep(1)
            browser.find_element_by_xpath("//*[@id='crawlerStep-copy']//span[text()='确认']").click()
            ...
            if alert.title_contains("操作成功"):
                ...
                log.warn("元素 {0} 复制失败，失败提示: {1}".format(copy_element, msg))
                result = False
            set_global_var("ResultMsg", msg, False)
            # 切换到节点iframe
            browser.switch_to.frame(
                browser.find_element_by_xpath("//iframe[contains(@src,'./node/crawlerNode.html?')]"))
            # 切换到业务配置iframe
            browser.switch_to.frame(browser.find_element_by_xpath("//iframe[@id='busi_crawler_node']"))
...
def element_set(**kwargs):
    ...
    if kwargs.__contains__("元素名称"):
        ...
        browser.find_element_by_xpath("//*[@name='elementName']/preceding-sibling::input").clear()
        browser.find_element_by_xpath("//*[@name='elementName']/preceding-sibling::input").send_keys(element_name)
    ...
    if kwargs.__contains__("元素类型"):
        ...
        browser.find_element_by_xpath("//*[@name='types']/preceding-sibling::input").click()
        browser.find_element_by_xpath("//*[contains(@id,'types') and text()='{0}']".format(element_type)).click()
    ...
    if kwargs.__contains__("动作"):
        ...
        browser.find_element_by_xpath("//*[@name='action']/preceding-sibling::input").click()
        browser.find_element_by_xpath(
            "//*[contains(@id,'elementaction') and text()='{0}']".format(element_action)).click()
    ...
    if kwargs.__contains__("标识类型"):
        ...
        browser.find_element_by_xpath("//*[@name='labelType']/preceding-sibling::input").click()
        browser.find_element_by_xpath(
            "//*[contains(@id,'labelType') and text()='{0}']".format(element_label_type)).click()
    ...
    if kwargs.__contains__("元素标识"):
        ...
        form_selector = "//*[@id='fetchConfig_form']"
        set_text_enable_var(input_xpath=input_xpath, form_selector=form_selector, msg=ele_label)
    ...
    if kwargs.__contains__("等待元素标识"):
        ...
        browser.find_element_by_xpath(input_xpath).clear()
        form_selector = "//*[@id='fetchConfig_form']"
        set_text_enable_var(input_xpath=input_xpath, form_selector=form_selector, msg=wait_ele_label)
    ...
    if kwargs.__contains__("等待元素标识类型"):
        ...
        browser.find_element_by_xpath("//*[@name='wait_labelType']/preceding-sibling::input").click()
        browser.find_element_by_xpath(
            "//*[contains(@id,'wait_labelType') and text()='{0}']".format(wait_element_label_type)).click()
    ...
    if kwargs.__contains__("最大等待时间"):
        ...
        browser.find_element_by_xpath("//*[@ID='maxTime']/following-sibling::span/input[1]").clear()
        browser.find_element_by_xpath("//*[@ID='maxTime']/following-sibling::span/input[1]").send_keys(max_time)
    ...
    if kwargs.__contains__("变量名"):
        ...
        browser.find_element_by_xpath("//*[@ID='varName']/following-sibling::span/input[1]").clear()
        browser.find_element_by_xpath("//*[@ID='varName']/following-sibling::span/input[1]").send_keys(var_name)
    ...
    if kwargs.__contains__("描述"):
        ...
        browser.find_element_by_xpath("//*[@name='elementDesc']/preceding-sibling::input").clear()
        browser.find_element_by_xpath("//*[@name='elementDesc']/preceding-sibling::input").send_keys(element_desc)
    ...
    if kwargs.__contains__("取数模式"):
        ...
        browser.find_element_by_xpath("//*[@name='accessMode']/preceding-sibling::input").click()
        browser.find_element_by_xpath("//*[contains(@id,'accessMode') and text()='{0}']".format(access_mode)).click()
    ...
    if kwargs.__contains__("值输入"):
        ...
        browser.find_element_by_xpath(input_xpath).clear()
        form_selector = "//*[@id='fetchConfig_form']"
        set_text_enable_var(input_xpath=input_xpath, form_selector=form_selector, msg=element_input)
    ...
    if kwargs.__contains__("敏感信息"):
        ...
        if is_sensitive == "是":
            browser.find_element_by_xpath("//*[@id='is_sensitive']/following-sibling::label").click()
            log.info("勾选 敏感信息")
            sleep(1)
    ...
    if kwargs.__contains__("下一页元素标识"):
        ...
        browser.find_element_by_xpath("//*[@id='nextElementLabel']/following-sibling::span/input[1]").clear()
        browser.find_element_by_xpath("//*[@id='nextElementLabel']/following-sibling::span/input[1]").send_keys(
            next_ele_label)
    ...
    if kwargs.__contains__("下一页标识类型"):
        ...
        browser.find_element_by_xpath("//*[@name='nextLabelType']/preceding-sibling::input").click()
        browser.find_element_by_xpath(
            "//*[contains(@id,'nextLabelType') and text()='{0}']".format(next_label_type)).click()
    ...
    if kwargs.__contains__("休眠时间"):
        ...
        browser.find_element_by_xpath("//*[@name='sleepTimes']/preceding-sibling::input").clear()
        browser.find_element_by_xpath("//*[@name='sleepTimes']/preceding-sibling::input").send_keys(sleep_times)
    ...
    if kwargs.__contains__("表格页数"):
        ...
        browser.find_element_by_xpath("//*[@id='pageCount']/following-sibling::span/input[1]").clear()
        browser.find_element_by_xpath("//*[@id='pageCount']/following-sibling::span/input[1]").send_keys(page_count)
    ...
    if kwargs.__contains__("是否配置期待值"):
        ...
        if expected_msg.get("flag") == "是":
            browser.find_element_by_xpath("//*[@id='is_expected']/following-sibling::label").click()
            log.info("勾选 是否配置期待值")
            focus = browser.find_element_by_xpath("//*[@name='expectedvalue']/preceding-sibling::input")
            ...
            if expected_msg.__contains__("期待值"):
                ...
                browser.find_element_by_xpath("//*[@name='expectedvalue']/preceding-sibling::input").clear()
                input_xpath = "//*[@name='expectedvalue']/preceding-sibling::input"
                form_selector = "//*[@id='fetchConfig_form']"
                set_text_enable_var(input_xpath=input_xpath, form_selector=form_selector,
                                    msg=expected_value)
            ...
            if expected_msg.__contains__("尝试次数"):
                ...
                browser.find_element_by_xpath("//*[@name='tryTime']/preceding-sibling::input").clear()
                browser.find_element_by_xpath("//*[@name='tryTime']/preceding-sibling::input").send_keys(try_time)
            ...
            if expected_msg.__contains__("等待时间"):
                ...
                browser.find_element_by_xpath("//*[@name='waitTime']/preceding-sibling::input").clear()
                browser.find_element_by_xpath("//*[@name='waitTime']/preceding-sibling::input").send_keys(wait_time)
    ...
    if kwargs.__contains__("循环次数"):
        ...
        browser.find_element_by_xpath("//*[@name='loopNum']/preceding-sibling::input").clear()
        browser.find_element_by_xpath("//*[@name='loopNum']/preceding-sibling::input").send_keys(loop_num)
    ...
    if kwargs.__contains__("_休眠时间"):
        ...
        browser.find_element_by_xpath("//*[@name='sleep']/preceding-sibling::input").clear()
        browser.find_element_by_xpath("//*[@name='sleep']/preceding-sibling::input").send_keys(_sleep)
    ...
    if kwargs.__contains__("附件"):
        ...
        if attach_msg.__contains__("附件来源"):
            ...
            browser.find_element_by_xpath("//*[text()='{0}']".format(attach_source)).click()
            ...
            if attach_source == "动态生成":
                ...
                if attach_msg.__contains__("附件标题"):
                    ...
                    browser.find_element_by_xpath(
                        "//*[@name='attachTitle']/preceding-sibling::input").send_keys(attach_title)
                ...
                if attach_msg.__contains__("附件内容"):
                    ...
                    browser.find_element_by_xpath(
                        "//*[@name='addAttachContent']/preceding-sibling::input").send_keys(attach_content)
                ...
                if attach_msg.__contains__("附件类型"):
                    ...
                    browser.find_element_by_xpath(
                        "//*[contains(@id,'attachType') and text()='{0}']".format(attach_type)).click()
                    log.info("设置 附件类型: {0}".format(attach_type))
                    sleep(1)

            elif attach_source == "本地上传":
                # 点击上传文件按钮
                browser.find_element_by_xpath("//*[@for='filebox_file_id_2']").click()
                ...
                # 远程加载
                if attach_msg.get("存储类型") == "是":
                    flag = True
                else:
                    flag = False
                attach_remote_set(storage_type=attach_msg.get("存储类型"), ftp=attach_msg.get("远程服务器"),
                                  dir_name=attach_msg.get("目录"), use_var=flag, choose_type=attach_msg.get("文件过滤方式"),
                                  file_name=attach_msg.get("文件名"), file_type=attach_msg.get("文件类型"))

    # 下载目录
    if kwargs.__contains__("下载目录"):
        path = kwargs.get("下载目录")
        browser.find_element_by_xpath("//*[@id='eledownloadtr']//input[1]").click()
        try:
            path_element = browser.find_element_by_xpath(
                "//*[contains(@id,'_easyui_tree_')]//*[text()='{0}']".format(path))
    ...
    if kwargs.__contains__("重复步骤"):
        ...
        browser.find_element_by_xpath("//*[@id='repeat_step']/following-sibling::span[1]//a").click()
        page_wait()
        ...
        # browser.switch_to.frame(browser.find_element_by_xpath("//iframe[contains(@src,'fetchStepList.html')]"))
        sleep(1)
        ...
        for s in repeat_step:
            try:
                browser.find_element_by_xpath("//*[contains(@id,'getdata_fetch')]//*[text()='{0}']".format(s)).click()
                sleep(1)
            except NoSuchElementException:
                page.set_page_size("50")
                browser.find_element_by_xpath("//*[contains(@id,'getdata_fetch')]//*[text()='{0}']".format(s)).click()
                ...
                # 添加到右边已选择
                browser.find_element_by_xpath("//*[@id='toRight']").click()
                ...
                if alert.title_contains("成功"):
                    ...
                    log.warn("选择重复步骤失败，失败提示: {0}".format(msg))
                set_global_var("ResultMsg", msg, False)
                ...
                # 切换到添加元素iframe
                browser.switch_to.frame(
                    browser.find_element_by_xpath("//iframe[contains(@src,'crawlerStepsList.html?')]"))
                # 切换到选择重复步骤iframe
                browser.switch_to.frame(
                    browser.find_element_by_xpath("//iframe[contains(@src,'crawlerStepsEdit.html?')]"))
                # 切换到选择重复步骤列表iframe
                browser.switch_to.frame(browser.find_element_by_xpath("//iframe[contains(@src,'fetchStepList.html')]"))

        # 关闭选择重复步骤页面
        browser.switch_to.parent_frame()
        browser.find_element_by_xpath("//*[text()='操作步骤检索页面']/following-sibling::div[1]/a[2]").click()
        sleep(1)

    # 保存元素
    browser.find_element_by_xpath("//*[@onclick='saveFetchElementContents()']//*[text()='保存']").click()
    ...
    if alert.title_contains("保存成功"):
        ...
        log.warn("元素操作失败，失败提示: {0}".format(msg))
        result = False
    set_global_var("ResultMsg", msg, False)
...
def attach_remote_set(storage_type, ftp, dir_name, use_var, choose_type, file_name, file_type):
    ...
    # 存储类型
    if storage_type:
        browser.find_element_by_xpath("//*[text()='{0}']".format(storage_type)).click()
    ...
    if choose_storage == "本地":
        ...
        # 聚焦元素
        enable_click = browser.find_element_by_xpath("//*[@for='local_isKeyword']")
        ...
        if use_var:
            ...
            if dir_name:
                ...
                browser.find_element_by_xpath(input_xpath).clear()
                form_selector = "//*[@id='fetchConfig_form']"
                set_text_enable_var(input_xpath=input_xpath, form_selector=form_selector, msg=dir_name)
        else:
            if status:
                enable_click.click()
            log.info("取消勾选【变量引用】")
            ...
            # 目录
            if dir_name:
                browser.find_element_by_xpath("//*[@id='local_choose_span']//input[1]").click()
                try:
                    path_element = browser.find_element_by_xpath(
                        "//*[contains(@id,'_easyui_tree_')]//*[text()='{0}']".format(dir_name))
                    browser.execute_script("arguments[0].scrollIntoView(true);", path_element)
                    path_element.click()
        ...
        # 远程服务器
        if ftp:
            browser.find_element_by_xpath("//*[@name='srcServerId']/preceding-sibling::input").click()
            browser.find_element_by_xpath(
                "//*[contains(@id,'remote_srcServerId') and text()='{0}']".format(ftp)).click()
            log.info("设置 远程服务器: {0}".format(ftp))
            sleep(1)

            # ftp目录
            if dir_name:
                browser.find_element_by_xpath("//*[@id='remote_choose_span']//input[1]").click()
    ...
    if choose_type:
        browser.find_element_by_xpath(
            "//*[@id='fileFilterType1']/following-sibling::span[1]//input[1]").click()
        browser.find_element_by_xpath(
            "//*[contains(@id,'fileFilterType1') and text()='{0}']".format(choose_type)).click()
        log.info("设置 文件过滤方式: {0}".format(choose_type))
        sleep(1)

    # 先获取文件过滤类型
    choose = browser.find_element_by_xpath("//*[@id='fileFilterType1']/following-sibling::span[1]/input[2]")
    ...
    if file_name:
        if choose_type == "关键字":
            ...
            browser.find_element_by_xpath(input_xpath).clear()
            form_selector = "//*[@id='fetchConfig_form']"
            set_text_enable_var(input_xpath=input_xpath, form_selector=form_selector, msg=file_name)
            log.info("设置 文件名: {0}".format(file_name))
            sleep(1)
        else:
            # 正则匹配
            browser.find_element_by_xpath(
                "//*[@id='keyExpr2']/following-sibling::span[1]//a[1]").click()
            sleep(1)
            # 切换到正则配置iframe页面
            browser.switch_to.frame(
                browser.find_element_by_xpath(
            ...
            if file_name.get("设置方式") == "添加":
                ...
                if alert.title_contains("成功"):
                    ...
                    # 切换到业务配置iframe
                    browser.switch_to.frame(
                        browser.find_element_by_xpath("//iframe[@id='busi_crawler_node']"))
                    # 切换到元素列表iframe
                    browser.switch_to.frame(
                        browser.find_element_by_xpath("//iframe[contains(@src,'crawlerStepsList.html')]"))
                    # 切换到元素配置iframe
    ...
    # 文件类型
    if file_type:
        browser.find_element_by_xpath("//*[@name='fileType1']/preceding-sibling::input").click()
        browser.find_element_by_xpath(
            "//*[contains(@id,'fileType1') and text()='{0}']".format(file_type)).click()
