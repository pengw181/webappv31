...
def script_param_set(param_key, param_type, param_value):
    ...
    row_index = browser.find_element_by_xpath(
        "//*[@field='paramName']/*[text()='{}']/../preceding-sibling::td/div".format(param_key)).get_attribute("innerText")
    # 行号从0开始，参数序号从1开始
    ...
    browser.find_element_by_xpath(
        "//*[contains(@id,'valType_{0}') and text()='{1}']".format(row_index, param_type)).click()
    sleep(1)
