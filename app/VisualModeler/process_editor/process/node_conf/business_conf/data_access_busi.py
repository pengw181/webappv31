...
def data_access_business(node_name, access_type, access_task_name, invoke_syn, advance_set):
    ...
    # 选择接入类型
    if access_type:
        browser.find_element_by_xpath("//*[@id='accessType']/following-sibling::span//a").click()
        access_type_element = browser.find_element_by_xpath(
            "//*[contains(@id,'accessType') and text()='{0}']".format(access_type))
    ...
    # 选择接入任务
    if access_task_name:
        browser.find_element_by_xpath("//*[@id='accessId']/following-sibling::span//a").click()
        access_task_element = browser.find_element_by_xpath(
            "//*[contains(@id,'accessId') and text()='{0}']".format(access_task_name))
    ...
    # 保存业务配置
    browser.find_element_by_xpath("//*[@onclick='saveAccessInfo()']//*[text()='保存']").click()
    log.info("保存业务配置")
