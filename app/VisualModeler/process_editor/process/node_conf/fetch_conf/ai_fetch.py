...
def ai_fetch(opt, target_var, var_name, value_type):
    ...
    if opt == "添加":
        browser.find_element_by_xpath("//*[@onclick='addGetInfo()']//*[text()='添加']").click()
        ...
        # 点击保存
        browser.find_element_by_xpath("//*[@onclick='addIRVar()']//*[text()='保存']").click()
        ...
        sleep(1)
        browser.find_element_by_xpath("//*[@onclick='edit_getdata_ir()']//*[text()='修改']").click()
        wait = WebDriverWait(browser, 30)
        wait.until(ec.element_to_be_clickable((By.XPATH, "//*[@name='varName']/preceding-sibling::input")))
        ...
        # 点击保存
        browser.find_element_by_xpath("//*[@onclick='edit_getdata_ir()']//*[text()='保存']").click()
        ...
        browser.find_element_by_xpath("//*[@field='varName']//*[text()='{0}']".format(target_var)).click()
        sleep(1)
        browser.find_element_by_xpath("//*[@onclick='del_getdata_ir()']//*[text()='删除']").click()
    ...
    # 切换到取数配置iframe
    browser.switch_to.frame(browser.find_element_by_xpath("//iframe[contains(@src,'getdataIrNode.html')]"))
