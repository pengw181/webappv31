...
def email_fetch(opt, target_var, var_name, var_type, attach_type, file_name, value_type):
    ...
    if opt == "添加":
        ...
        browser.switch_to.frame(
            browser.find_element_by_xpath("//iframe[contains(@src,'addEmailNodeVar.html')]"))
    ...
    # 切换到取数配置iframe
    browser.switch_to.frame(browser.find_element_by_xpath("//iframe[contains(@src,'getdataEmailNode.html')]"))
