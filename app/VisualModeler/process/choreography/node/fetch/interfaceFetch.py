...
def interface_fetch(opt, target_var, var_name, expression, value_type):
    ...
    if opt == "添加":
        ...
        browser.find_element_by_xpath("//*[@field='varName']//*[text()='{0}']".format(target_var)).click()
        sleep(1)
        browser.find_element_by_xpath("//*[@onclick='del_getdata_port();']//*[text()='删除']").click()
    ...
    # 切换到取数配置iframe
    browser.switch_to.frame(browser.find_element_by_xpath("//iframe[contains(@src,'getDataPortNode.html')]"))
