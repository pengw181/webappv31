...
from app.VisualModeler.process.choreography.node.business.cmdParam import cmd_node_param_set
...
def add_by_ne(level, level_member, ne_type, vendor, model, ne_list, cmd_set):
    ...
    if ne_list:
        ...
        for ne in ne_list:
            ...
            try:
                # 默认自动选中
                netunit_row = browser.find_element_by_xpath(
                    "//*[@field='childNetunitName']/*[text()='pw_华为_MME_ME60_00']/../..")
