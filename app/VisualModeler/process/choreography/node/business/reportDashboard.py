...
class ReportDashboard:
    ...
    def access_report_dashboard(self, process_name, node_name):
        ...
        # 是否在报表节点页面
        try:
            self.browser.find_element_by_xpath("//*[@id='form_id']//*[text()='仪表盘配置']")
        except NoSuchElementException:
            node_element = self.browser.find_element_by_xpath(
        ...
        # 点击仪表盘配置，进入仪表盘主配置页
        self.browser.find_element_by_xpath("//*[@id='dashboard_cfg']").click()
    ...
    @staticmethod
    def set_dictionary(dictionary_list):
        """
    ...
    def refresh_report_node(self):
        ...
        self.current_win_handle.switch("流程图编辑器")
        # 点击刷新
        self.browser.find_element_by_xpath("//*[@onclick='queryVarCfgList()']").click()
        set_global_var("ResultMsg", "操作成功", False)
    ...
    def view_dashboard(self, var_name):
        ...
        sleep(1)
        # 点击图像预览
        self.browser.find_element_by_xpath("//*[text()='{0}']/../following-sibling::td[2]//a".format(var_name)).click()
