...
def radar_style(theme, custom_bg_color, bg_color_rgb, show_legend, legend_direction, legend_align, legend_font_size,
    ...
    if min_value:
        ...
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@data-i18n-text='imageCfg.minValue']/following-sibling::input[1]").send_keys(
            min_value)
    ...
    if max_value:
        ...
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@data-i18n-text='imageCfg.maxValue']/following-sibling::input[1]").send_keys(
            max_value)
