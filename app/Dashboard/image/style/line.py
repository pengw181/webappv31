...
def line_style(theme, custom_theme_colors, custom_bg_color, bg_color_rgb, area_fill_color, show_metrics,
               metrics_font_size, show_title, title_alignment, title_font_size, axis_name_font_size,
               axis_tick_label_font_size, x_axis_area_zoom, y_axis_area_zoom):
    """
    # 折线图
    :param theme: 主题样式
    ...
    if theme:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[text()='主题样式']/following-sibling::div[1]/div").click()
        browser.find_element_by_xpath(tab_div_xpath + "//*[text()='{0}']".format(theme)).click()
    ...
    if custom_theme_colors:
        ...
        for colors in custom_theme_colors:
            browser.find_element_by_xpath(tab_div_xpath + "//*[@name='border-color']").send_keys(colors)
            browser.find_element_by_xpath(tab_div_xpath + "//*[@title='增加自定义主题色彩']").click()
    ...
    if custom_bg_color:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@name='whetherCustomBgColor']/following-sibling::span[text()='{0}']".format(
    ...
    if area_fill_color:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[text()='区域填充颜色']/following-sibling::label//*[text()='{0}']".format(
    ...
    if show_metrics:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@name='showMeasure']/following-sibling::span[text()='{0}']".format(
                show_metrics)).click()
        log.info("设置是否显示度量: {0}".format(show_metrics))

    # 度量字体大小
    if metrics_font_size:
        slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='labelFontSize']")
        basic_value = slider.get_attribute("value")
        x_offset = (int(metrics_font_size) - int(basic_value)) * 5
        size_slider = browser.find_element_by_xpath(
            "//*[@id='labelFontSize']/following-sibling::div[1]//a")
    ...
    if show_title:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@name='title-show']/following-sibling::span[text()='{0}']".format(
                show_title)).click()
    ...
    if title_alignment:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@name='title-align']/following-sibling::span[text()='{0}']".format(
    ...
    # 标题字体大小
    if title_font_size:
        slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='title-fontSize']")
        basic_value = slider.get_attribute("value")
        x_offset = (int(title_font_size) - int(basic_value)) * 5  # 每个步进值5个像素
        size_slider = browser.find_element_by_xpath("//*[@id='title-fontSize']/following-sibling::div[1]//a")
        action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
    ...
    if axis_name_font_size:
        slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='nameTextStyle-fontSize']")
        basic_value = slider.get_attribute("value")
        x_offset = (int(axis_name_font_size) - int(basic_value)) * 5
        size_slider = browser.find_element_by_xpath(
            "//*[@id='nameTextStyle-fontSize']/following-sibling::div[1]//a")
        action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
    ...
    if axis_tick_label_font_size:
        slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='axisLabel-fontSize']")
        basic_value = slider.get_attribute("value")
        x_offset = (int(axis_tick_label_font_size) - int(basic_value)) * 5
        size_slider = browser.find_element_by_xpath(
            "//*[@id='axisLabel-fontSize']/following-sibling::div[1]//a")
        action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
    ...
    if x_axis_area_zoom:
        ...
        if tmp ^ status:
            browser.find_element_by_xpath(tab_div_xpath + "//*[@id='xDataZoomCfg']").click()
            log.info("{0}X轴区域缩放".format(xAxis_status))
            sleep(1)

        # X轴起始百分比
        if xAxis_start:
            slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='xAxis_start']")
            basic_value = slider.get_attribute("value")
            x_offset = (int(xAxis_start) - int(basic_value)) * 2
            size_slider = browser.find_element_by_xpath("//*[@id='xAxis_start']/following-sibling::div[1]//a")
            action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
        ...
        # X轴结束百分比
        if xAxis_end:
            slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='xAxis_end']")
            basic_value = slider.get_attribute("value")
            x_offset = (int(xAxis_end) - int(basic_value)) * 2
            size_slider = browser.find_element_by_xpath("//*[@id='xAxis_end']/following-sibling::div[1]//a")
            action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
    ...
    if y_axis_area_zoom:
        ...
        if tmp ^ status:
            browser.find_element_by_xpath(tab_div_xpath + "//*[@id='yDataZoomCfg']").click()
            log.info("{0}Y轴区域缩放".format(yAxis_status))
            sleep(1)

        # Y轴起始百分比
        if yAxis_start:
            slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='yAxis_start']")
            basic_value = slider.get_attribute("value")
            x_offset = (int(yAxis_start) - int(basic_value)) * 2
            size_slider = browser.find_element_by_xpath("//*[@id='yAxis_start']/following-sibling::div[1]//a")
            action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
        ...
        # Y轴结束百分比
        if yAxis_end:
            slider = browser.find_element_by_xpath(tab_div_xpath + "//*[@id='yAxis_end']")
            basic_value = slider.get_attribute("value")
            x_offset = (int(yAxis_end) - int(basic_value)) * 2
            size_slider = browser.find_element_by_xpath("//*[@id='yAxis_end']/following-sibling::div[1]//a")
            action.drag_and_drop_by_offset(size_slider, x_offset, 0).perform()
