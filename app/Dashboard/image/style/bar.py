...
def bar_style(theme, custom_theme_colors, custom_bg_color, bg_color_rgb, data_dis_direction, show_metrics,
    ...
    if data_dis_direction:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[@name='data-direction']/following-sibling::span[text()='{0}']".format(
    ...
    if image_type:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[text()='图像类型']/following-sibling::div[1]//*[text()='{0}']".format(
                image_type)).click()
    ...
    if area_fill_color:
        browser.find_element_by_xpath(
            tab_div_xpath + "//*[text()='区域填充颜色']/following-sibling::label[1]//*[text()='{0}']".format(
