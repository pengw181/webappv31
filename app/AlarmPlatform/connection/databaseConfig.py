...
class DatabaseConfig:
    ...
    def choose(self, database_name):
        ...
        """
        input_ele = self.browser.find_element_by_xpath("//*[@id='databaseName']/following-sibling::span[1]/input[1]")
        input_ele.clear()
        input_ele.send_keys(database_name)
        self.browser.find_element_by_xpath("//span[text()='查询']").click()
        page_wait()
        self.browser.find_element_by_xpath("//*[@field='databaseName']//a[text()='{}']".format(database_name)).click()
    ...
    def add(self, database_type, database_name, database_sid, address, port, username, password):
        ...
        :param password: 密码
        """
        self.browser.find_element_by_xpath("//*[@id='databaseName']/following-sibling::span[1]/input[1]").clear()
        self.browser.find_element_by_xpath(
            "//*[@id='databaseName']/following-sibling::span[1]/input[1]").send_keys(database_name)
        self.browser.find_element_by_xpath("//*[text()='查询']").click()
        page_wait()
        sleep(1)
        try:
            self.browser.find_element_by_xpath("//*[@field='databaseName']//a[text()='{}']".format(database_name))
            ...
            if alert.title_contains("操作成功"):
                ...
                log.warn("数据 {0} 添加失败，失败提示: {1}".format(database_name, msg))
    ...
    def database_page(self, database_type, database_name, database_sid, address, port, username, password):
        ...
        if database_type:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseType']/following-sibling::span//a").click()
            self.browser.find_element_by_xpath(
                "//*[contains(@id,'databaseType') and text()='{0}']".format(database_type)).click()
            log.info("设置数据库类型: {0}".format(database_type))

        # 数据库名称
        if database_name:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseName']/following-sibling::span/input[1]").clear()
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseName']/following-sibling::span/input[1]").send_keys(database_name)
            log.info("设置数据库名称: {0}".format(database_name))

        # 服务名/SID
        if database_sid:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseSid']/following-sibling::span/input[1]").clear()
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseSid']/following-sibling::span/input[1]").send_keys(
                database_sid)
        ...
        if address:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseAddress']/following-sibling::span/input[1]").clear()
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseAddress']/following-sibling::span/input[1]").send_keys(
                address)
        ...
        if port:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databasePort']/following-sibling::span/input[1]").clear()
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databasePort']/following-sibling::span/input[1]").send_keys(
                port)
        ...
        if username:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseUsername']/following-sibling::span/input[1]").clear()
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databaseUsername']/following-sibling::span/input[1]").send_keys(
                username)
        ...
        if password:
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databasePassword']/following-sibling::span/input[1]").clear()
            self.browser.find_element_by_xpath(
                "//*[@id='editDiv']//*[@id='databasePassword']/following-sibling::span/input[1]").send_keys(
                password)
            sleep(1)
            log.info("设置密码: {0}".format(password))

        # 提交
        self.browser.find_element_by_xpath("//*[@id='submitButtonId']//*[text()='提交']").click()
    ...
    def test(self, database_name):
        ...
        wait.until(ec.element_to_be_clickable((
            By.XPATH, "//*[@id='editDiv']//*[@id='databaseName']/following-sibling::span/input[1]")))
        self.browser.find_element_by_xpath("//*[@id='testButtonId']//*[text()='测试']").click()
        alert = BeAlertBox(back_iframe=True, timeout=60)
        msg = alert.get_msg()
        if alert.title_contains("测试成功"):
            log.info("{0} 测试成功".format(database_name))
        else:
            log.warn("{0} 测试失败，测试返回结果: {1}".format(database_name, msg))
        set_global_var("ResultMsg", msg, False)
