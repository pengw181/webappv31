...
def cmd_node_choose_member(member_list):
    ...
    for member in member_list:
        ...
        ne_element = browser.find_element_by_xpath("//*[contains(@id,'netunit_id_') and text()='{0}']".format(member))
...
def cmd_set_choose_level(level_list):
    ...
    for level in level_list:
        ...
        try:
            first_level_xpath = "//*[@id='cmdInfoForm']/following-sibling::div[6]//*[contains(@id,'_tree_')]/span[@class='tree-title' and text()='{}']".format(first_level)
