...
class Pagination:
    ...
    def get_total_page_num(self):
        total_page = self.browser.find_element_by_xpath(self.table_xpath + "//td[8]/span").get_attribute("innerHTML")
        patt = r'共(\d+)页'
    ...
    def get_total_num(self):
        total_num = self.browser.find_element_by_xpath(
            self.table_xpath + "/following-sibling::div[1]").get_attribute("innerHTML")
    ...
    def next_page(self):
        next_click = self.browser.find_element_by_xpath(self.table_xpath + "//td[10]/a")
    ...
    def pre_page(self):
        pre_click = self.browser.find_element_by_xpath(self.table_xpath + "//td[4]/a")
    ...
    def step_to_page(self, page_index=1):
        ...
        try:
            self.browser.find_element_by_xpath(self.table_xpath + "//td[7]/input").clear()
            self.browser.find_element_by_xpath(self.table_xpath + "//td[7]/input").send_keys(page_index)
            k = PyKeyboard()
            k.press_keys(['Return'])
